        ...
        <form className="flex flex-wrap w-full  items-start justify-between">
          <div className=" w-1/2 ">
            ...
            <div>
              ...
              <input type="text" className="text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px]" placeholder="Employee Name" />
            </div>

            <div>
              <h3 className="text-sm text-gray-300 mb-0.5">Category</h3>
              <input type="text" className="text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px]" placeholder="Design, dev, etc.." />
            </div>
          </div>
